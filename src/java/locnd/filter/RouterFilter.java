...
public class RouterFilter implements Filter {
    ...
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
        ...
        if (url.contains("footer.jsp") || (url.contains("header") && url.endsWith(".jsp"))) {
            httpRespond.sendRedirect("index.jsp");
        }
        if (url.contains("quickRegister.jsp")) {
            httpRespond.sendRedirect("registration.jsp");
        }
